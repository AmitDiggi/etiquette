...
public class ProductTests {
    ...
    public void verifyProductsWithGSTCount(){
        ...
        Shop productWithGST = products.getAllProductsHasGST();
        Assert.assertEquals(productWithGST.getProductCount(),4);
    ...
    public void verifyProductsWithGSTANDWithMRPMoreThanTwoThousand(){
        ...
        Shop productWithGST = products.getAllProductsHasGSTWithMRPMoreThanTwoThousand();
        Assert.assertEquals(productWithGST.getProductCount(),3);
